sap.ui.jsview("zsap_idea.Home", {
	...
	*/ 
	createContent : function(oController) {
		...
		domain = "proxy/http/bglr-sapsrv01.quinnox.corp:8000";
...
//					src: "images/quinnox-branding-logo.png",
//					width: "120px",
//					height: "30px"
//				})
//			}),
...
//		return oPage;
		...
		var oShell = new sap.ui.unified.Shell('shellLayout',{
			showPane:false,
			icon:"images/quinnox-branding-logo.png",
			headerHeading:'EFL Customer Care',
			headerVisible:true,
			searchVisible:true,
			paneContent:[],
